...
<section id="body-section">
		<form action="customerRegistration" id="seller-registration-form" method="post">
			...
			<div id="form-wrapper">
				<div  id="user-details">
					<div>
						<input type="text" placeholder="User Name *" id="sellerName"  required="required"/>
						<small></small>
					</div>
					...
					<div>
						<input type="text" placeholder="Age" id="registrationNumber" required="required"/>
						<small></small>
					</div>
					<div>
						<input type="text" placeholder="Contact Number1 (mobile) *" id="phoneNumber1" required="required"/>
						<small></small>
					</div>
					<div>
						<input type="text" placeholder="Contact Number2 (landline|mobile)" id="phoneNumber2" required="required"/>
						<small></small>
					</div>
				</div>
