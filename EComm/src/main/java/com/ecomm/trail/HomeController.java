...
public class HomeController {
	...
	public ModelAndView Registration(Locale locale, Model model) {
		...
		return new ModelAndView("Registration","registration",new com.ecomm.trail.RegistrationPojo());
	}
	
	@RequestMapping(value="/proceedRegister", method=RequestMethod.POST)
	public String addCustomer(@ModelAttribute("registration")com.ecomm.trail.RegistrationPojo register, BindingResult result) {
